...
- [Notes](#notes)
  - [Install these extensions when running .NET code in the VS code](#install-these-extensions-when-running-net-code-in-the-vs-code)
  - [Set the .NET SDK version](#set-the-net-sdk-version)
  - [Create the project](#create-the-project)
  - [Build the code into binary](#build-the-code-into-binary)
  - [Run the application in the debug mode](#run-the-application-in-the-debug-mode)
    - [Try debugging](#try-debugging)
  - [Test APIs](#test-apis)
  - [For the put endpoint](#for-the-put-endpoint)
    - [What is DTO](#what-is-dto)
  - [Always consider the extra case](#always-consider-the-extra-case)
  - [`this WebApplication app` - the extension method](#this-webapplication-app---the-extension-method)
    - [Why WebApplication specifically](#why-webapplication-specifically)
    - [Why use this pattern](#why-use-this-pattern)
  - [The benefit of using `RouteGroupBuilder` instead of `WebApplication` in the GamesEndpoints](#the-benefit-of-using-routegroupbuilder-instead-of-webapplication-in-the-gamesendpoints)
    - [Other benefits of grouping](#other-benefits-of-grouping)
    - [Why RouteGroupBuilder as the return type](#why-routegroupbuilder-as-the-return-type)
  - [Handle invalid inputs](#handle-invalid-inputs)
  - [Setup Entity Framework Core](#setup-entity-framework-core)
    - [The Need For Object-Relational Mapping (O/RM)](#the-need-for-object-relational-mapping-orm)
    - [What is ORM](#what-is-orm)
    - [Create data models](#create-data-models)
    - [Add the datbase engine for this project](#add-the-datbase-engine-for-this-project)
    - [Create a DbContext](#create-a-dbcontext)
    - [Configuration System](#configuration-system)
    - [Setup database migrations](#setup-database-migrations)
    - [Inside the migration file](#inside-the-migration-file)
    - [About SQLite database in this project](#about-sqlite-database-in-this-project)
    - [Add migration automated setup](#add-migration-automated-setup)
    - [How to seed the data](#how-to-seed-the-data)
    - [Dependency Injection](#dependency-injection)
    - [The flow in `GamesEndpoints`](#the-flow-in-gamesendpoints)
    - [LINQ vs EF Core specific methods in `GamesEndpoints`](#linq-vs-ef-core-specific-methods-in-gamesendpoints)
  - [Add asynchronous model](#add-asynchronous-model)
  - [Change the logging information](#change-the-logging-information)
- [Course](#course)
...
Following the `ASP.NET Core Full Course For Beginners (.NET 8)` course [here](https://www.youtube.com/watch?v=AhAxLiGC7Pc&t=13212s).
